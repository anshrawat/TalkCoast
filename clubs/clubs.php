        ...
        <div class="side_menu">
            ...
            <div class="menu" style="margin-top: 40px;">
                <div class="contain-menu">
                    <ul>
                        <li>
                            <a href="http://localhost:8080/Talkcoast/dashboard.php">
                            <span class="icon"><i class="fa fa-tachometer"></i></span>
                            <span class="title">Dashboard</span>
                        </a>
                        </li>
                        <li>
                            <a href="http://localhost:8080/Talkcoast/profile1.php">
                            <span class="icon"><i class="fa fa-user-circle"></i></span>
                            <span class="title">Profile</span>
                        </a>
                        </li>
                        <li>
                            <a href="http://localhost:8080/Talkcoast/blog/index2.php">
                            <span class="icon"><i class="fa fa-pencil"></i></span>
                            <span class="title">Post A Blog</span>
                        </a>
                        </li>
                        <li>
                            <a href="http://localhost:8080/Talkcoast/placem/placement.php">
                        ...
                        <li>
                            <a href="http://localhost:8080/Talkcoast/index.php">
                       ...
                       <div classs="col-sm-10">
                           <div class="col-sm-3">
                               <div class="machine">
                                   ...
                                   <a id="joinS"href="http://localhost:8080/Talkcoast/clubs/comments3/" style=" margin-left:16px; width:100px; border:white;color:white; padding:5px 5px; margin-top: 10px;background:#29AB87; border-radius: 5px; font-family: 'Poppins',sans-serif;">JOIN CLUBS</a>
                           ...
                           <div class="col-sm-3">
                            <div class="datastructure">
                                ...
                                <a id="joinS"href="http://localhost:8080/Talkcoast/clubs/comments/" style=" margin-left:16px; width:100px; border:white;color:white; padding:5px 5px; margin-top: 10px;background:#29AB87; border-radius: 5px; font-family: 'Poppins',sans-serif;">JOIN CLUBS</a>
                           ...
                           <div class="col-sm-3">
                            <div class="web">
                                ...
                                <a id="joinS"href="http://localhost:8080/Talkcoast/clubs/comments1/" style=" margin-left:16px; width:100px; border:white;color:white; padding:5px 5px; margin-top: 10px;background:#29AB87; border-radius: 5px; font-family: 'Poppins',sans-serif;">JOIN CLUBS</a>
                           ...
                           <div class="col-sm-3">
                            <div class="sports">
                                ...
                                <a id="joinS"href="http://localhost:8080/Talkcoast/clubs/comments2/" style=" margin-left:16px; width:100px; border:white;color:white; padding:5px 5px; margin-top: 10px;background:#29AB87; border-radius: 5px; font-family: 'Poppins',sans-serif;">JOIN CLUBS</a>
