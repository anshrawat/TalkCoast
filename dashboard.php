               ...
               <div class="col-sm-4 padd-off">
                ...
                <div class="comments_notify" id="">
                    <nav class="comments_notify_nav">
                        ...
                        <button id="view" type="button" style="width:90px; border:white;color:white; padding:5px 5px; margin-top: 130px;background:#4e73df; font-family: 'Poppins',sans-serif;">VIEW MORE</button>
                    </nav>
